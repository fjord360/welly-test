...
const DayStayCard: React.FC<DayStayCardProps> = ({ Stay, className = "" }) => {
  ...
  return (
    <div className={`overflow-hidden ${className}`}>
      ...
      <div className="relative">
        ...
        {/* 설명 */}
        <div className="pt-6">
          <div className="text-gray-500 text-xs font-regular mb-2">
            {Stay.type}
          </div>
          <h2 className="text-xl font-bold text-gray-900 mb-4">{Stay.title}</h2>
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-2">
          {Stay.amenities.map((amenity, index) => (
            <div key={index} className="flex items-center gap-1">
              ...
              />
              <p className="text-gray-600 text-xs">{amenity}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  const StayList: StayItem[] = [
    {
      ...
      description:
        "2023년 오픈한 침실 6개짜리 빌라입니다. 북유럽의 현대적인 느낌으로 디자인된 코티지로, 거실에서 별이 빛나는 하늘과 벽난로의 따뜻한 분위기로 꾸며져 있습니다. 또한 대형 온수 욕조와 사우나도 있어 편안한 휴식을 취할 수 있어요.",
      amenities: [
        "어메니티",
        "타월",
        "드라이기",
      ...
      <div className="mt-6">
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex-7">
                  <h3 className="text-base font-bold text-gray-800 mb-1">
                    ...
                    {accommodation.englishName && (
                      <div className="text-base text-gray-800 font-bold mt-1">
                        {accommodation.englishName}
                      </div>
                    )}
                  </h3>
                ...
                <div className="flex-11">
                  <div className="text-right font-semibold text-sm text-gray-800 mb-2">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 text-gray-700 mb-4">
            <span className="w-1 h-1 bg-gray-900 rounded-full pl-1"></span>
        ...
        <div className="space-y-4">
          {notices.map((notice, index) => (
            <div
              key={index}
              className="mb-6 p-2 border border-red-650 rounded-2xl w-fit"
            >
